...
public class SpawnprocedureProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((world.getBlockState(BlockPos.containing(x + 0, y + 0, z + 0))).getBlock() == MechafrontModBlocks.BOSS_ACTIVATOR.get() && (world.getBlockState(BlockPos.containing(x + 0, y - 1, z + 0))).getBlock() == Blocks.REDSTONE_BLOCK
			...
			if (entity instanceof ServerPlayer _player) {
				AdvancementHolder _adv = _player.server.getAdvancements().get(ResourceLocation.parse("mechafront:final_fight"));
				if (_adv != null) {
			...
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = MechafrontModEntities.ENEMY_TITAN_BOSS.get().spawn(_level, BlockPos.containing(x, y - 1, z), MobSpawnType.MOB_SUMMONED);
			...
			world.setBlock(BlockPos.containing(x - 1, y - 1, z), Blocks.AIR.defaultBlockState(), 3);
		} else if ((world.getBlockState(BlockPos.containing(x + 0, y + 0, z + 0))).getBlock() == MechafrontModBlocks.BOSS_ACTIVATOR.get() && (world.getBlockState(BlockPos.containing(x + 0, y - 1, z + 0))).getBlock() == Blocks.REDSTONE_BLOCK
		...
		if ((world.getBlockState(BlockPos.containing(x + 0, y + 0, z + 0))).getBlock() == MechafrontModBlocks.TITAN_SUMMONER.get() && (world.getBlockState(BlockPos.containing(x + 0, y - 1, z + 0))).getBlock() == Blocks.DIAMOND_BLOCK
			...
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = MechafrontModEntities.TITAN_ROBOT.get().spawn(_level, BlockPos.containing(x, y - 1, z), MobSpawnType.MOB_SUMMONED);
				if (entityToSpawn != null) {
					entityToSpawn.setYRot(world.getRandom().nextFloat() * 360F);
				}
			}
			...
			world.setBlock(BlockPos.containing(x + 1, y - 1, z), Blocks.AIR.defaultBlockState(), 3);
			world.setBlock(BlockPos.containing(x - 1, y - 1, z), Blocks.AIR.defaultBlockState(), 3);
		} else if ((world.getBlockState(BlockPos.containing(x + 0, y + 0, z + 0))).getBlock() == MechafrontModBlocks.TITAN_SUMMONER.get() && (world.getBlockState(BlockPos.containing(x + 0, y - 1, z + 0))).getBlock() == Blocks.DIAMOND_BLOCK

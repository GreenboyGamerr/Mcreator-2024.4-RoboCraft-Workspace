...
import net.mcreator.mechafront.procedures.Phase2ticksProcedure;
import net.mcreator.mechafront.procedures.Phase2DieProcedure;

public class EnemyTitanBoss2Entity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(EnemyTitanBoss2Entity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(EnemyTitanBoss2Entity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(EnemyTitanBoss2Entity.class, EntityDataSerializers.STRING);
	...
	public EnemyTitanBoss2Entity(EntityType<EnemyTitanBoss2Entity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(14, new NearestAttackableTargetGoal(this, MechaSuitMediumEntity.class, false, false));
	...
	public void die(DamageSource source) {
		super.die(source);
		Phase2DieProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
	...
	public void baseTick() {
		super.baseTick();
		Phase2ticksProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	protected void tickDeath() {
		++this.deathTime;
		if (this.deathTime == 1) {
			this.remove(EnemyTitanBoss2Entity.RemovalReason.KILLED);

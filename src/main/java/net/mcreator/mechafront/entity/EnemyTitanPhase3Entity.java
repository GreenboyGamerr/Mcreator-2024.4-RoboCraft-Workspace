...
import net.mcreator.mechafront.procedures.Phase3TicksProcedure;
import net.mcreator.mechafront.procedures.EnemyTitanPhase3DeathTimeIsReachedProcedure;
import net.mcreator.mechafront.procedures.EnemyTitanBossEntityDiesProcedure;

public class EnemyTitanPhase3Entity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(EnemyTitanPhase3Entity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(EnemyTitanPhase3Entity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(EnemyTitanPhase3Entity.class, EntityDataSerializers.STRING);
	...
	public EnemyTitanPhase3Entity(EntityType<EnemyTitanPhase3Entity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public void die(DamageSource source) {
		super.die(source);
		EnemyTitanPhase3DeathTimeIsReachedProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
	...
	public void baseTick() {
		super.baseTick();
		Phase3TicksProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	private PlayState movementPredicate(AnimationState event) {
		if (this.animationprocedure.equals("empty")) {
			...
			if (this.isDeadOrDying()) {
				return event.setAndContinue(RawAnimation.begin().thenPlay("die2"));
			}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(EnemyTitanPhase3Entity.RemovalReason.KILLED);
			this.dropExperience(this);
			EnemyTitanBossEntityDiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
		}
	}

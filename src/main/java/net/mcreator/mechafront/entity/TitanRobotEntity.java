...
import net.mcreator.mechafront.procedures.EnemyTitanBossOnEntityTickUpdateProcedure;
import net.mcreator.mechafront.init.MechafrontModEntities;

import java.util.List;

public class TitanRobotEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(TitanRobotEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(TitanRobotEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(TitanRobotEntity.class, EntityDataSerializers.STRING);
	...
	public TitanRobotEntity(EntityType<TitanRobotEntity> type, Level world) {
		super(type, world);
		xpReward = 20;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(10, new NearestAttackableTargetGoal(this, EnemyTitanBossEntity.class, false, false));
	...
	public void baseTick() {
		super.baseTick();
		EnemyTitanBossOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		TitanRobotEntity retval = MechafrontModEntities.TITAN_ROBOT.get().create(serverWorld);
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.KNOCKBACK_RESISTANCE, 123);
		return builder;
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 40) {
			this.remove(TitanRobotEntity.RemovalReason.KILLED);

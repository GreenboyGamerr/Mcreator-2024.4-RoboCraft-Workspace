...
import net.mcreator.robocraft.entity.CannonFireEntity;
import net.mcreator.robocraft.RobocraftMod;

@EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD)
public class RobocraftModEntities {
	public static final DeferredRegister<EntityType<?>> REGISTRY = DeferredRegister.create(Registries.ENTITY_TYPE, RobocraftMod.MODID);
	...
	public static final DeferredHolder<EntityType<?>, EntityType<TitanRobotEntity>> TITAN_ROBOT = register("titan_robot",
			EntityType.Builder.<TitanRobotEntity>of(TitanRobotEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).fireImmune().sized(0.6f, 5f));
	...
	public static final DeferredHolder<EntityType<?>, EntityType<DefenderRobotSuitEntity>> DEFENDER_ROBOT_SUIT = register("defender_robot_suit",
			EntityType.Builder.<DefenderRobotSuitEntity>of(DefenderRobotSuitEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).fireImmune().sized(0.6f, 5f));
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		...
		DefenderRobotSuitEntity.init(event);
	}
	...
	public static void registerAttributes(EntityAttributeCreationEvent event) {
		...
		event.put(DEFENDER_ROBOT_SUIT.get(), DefenderRobotSuitEntity.createAttributes().build());
	}
}

...
public class Phase2ticksProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (!((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) == null)) {
			RobocraftModVariables.fight = RobocraftModVariables.fight + 1;
			if (RobocraftModVariables.fight == 100) {
				if (world instanceof ServerLevel _level) {
					Entity entityToSpawn = RobocraftModEntities.CURRUPTED_ROBO.get().spawn(_level, BlockPos.containing(x, y, z), MobSpawnType.MOB_SUMMONED);
			...
			if (RobocraftModVariables.fight == 200) {
					...
					if (!projectileLevel.isClientSide()) {
						Projectile _entityToSpawn = new Object() {
							public Projectile getArrow(Level level, float damage, int knockback, byte piercing) {
								AbstractArrow entityToSpawn = new CannonFireEntity(RobocraftModEntities.CANNON_FIRE.get(), level) {
									@Override
			...
			if (RobocraftModVariables.fight == 300) {
				if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
					_entity.addEffect(new MobEffectInstance(MobEffects.GLOWING, 100, 255, false, false));
				if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
					_entity.addEffect(new MobEffectInstance(MobEffects.REGENERATION, 100, 7, false, false));
			}
			if (RobocraftModVariables.fight == 400) {
				if (world instanceof ServerLevel _level) {
